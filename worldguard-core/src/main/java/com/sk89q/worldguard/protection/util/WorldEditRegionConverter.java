...
public final class WorldEditRegionConverter {
    ...
    public static RegionSelector convertToSelector(ProtectedRegion region) {
        ...
        if (region instanceof ProtectedCylinderRegion cylinderRegion) {
            return new CylinderRegionSelector(null,
                    cylinderRegion.getCenter().toBlockPoint(), cylinderRegion.getRadius(),
                    cylinderRegion.getMinimumPoint().y(), cylinderRegion.getMaximumPoint().y());
        }
        return null;
    }
}
